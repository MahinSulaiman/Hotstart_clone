...
const Welcome=()=>{
    return (
      ...
      <div className=" ml-8 pl-48 pt-45 absolute mt-44">
       ...
       <button className="bg-gray-500 w-80 hover:bg-gray-600 text-white-bold rounded-md py-2 px-2 opacity-50 mt-5"> Subscribe</button>
       <button className="bg-gray-500 w-20 hover:bg-gray-600 text-white-bold rounded-md py-2 px-4 opacity-50 mt-5 ml-2"> +</button>
      </div>
        </>
    )
}
